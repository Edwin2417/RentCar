...
SECRET_KEY = 'django-insecure-jys!*8%tmowe$by+m1818ymtyd1b2a5ymx1sea2q#7zrdug2r@'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    'rentCarApp.apps.RentcarappConfig',
]
...
MIDDLEWARE = [
    ...
    'rentCarApp.middleware.UserSessionMiddleware',
]
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'rentCarApp/static']
